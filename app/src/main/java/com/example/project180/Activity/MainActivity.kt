...
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.imageView2.setOnClickListener{startActivity(Intent(this,MapsActivity::class.java))}

        binding.imageView4.setOnClickListener{startActivity(Intent(this,SomosActivity::class.java))}

        binding.imageView13.setOnClickListener{startActivity(Intent(this,AboutActivity::class.java))}
    }
